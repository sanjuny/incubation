      ...
      <div className="max-w-4xl flex items-center h-auto lg:h-screen flex-wrap mx-auto my-32 lg:my-0">
        ...
        <div className="w-full lg:w-3/5 rounded-lg lg:rounded-l-lg lg:rounded-r-none shadow-2xl bg-silver-300 opacity-75 mx-6 lg:mx-0">
          ...
          <div className="p-4 md:p-12 text-center lg:text-left">
            ...
            <div className="secondback block lg:hidden rounded-full shadow-xl mx-auto -mt-16 h-48 w-48 bg-cover bg-center"></div>

            <h1 className="text-3xl font-bold pt-8 lg:pt-0">Welcome to Incubation</h1>
